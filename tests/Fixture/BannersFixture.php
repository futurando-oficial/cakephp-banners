<?php
namespace Banners\Test\Fixture;
...
class BannersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'alt' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'file' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'file_mobile' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'file_mobile' => 'Lorem ipsum dolor sit amet',
                'link' => 'Lorem ipsum dolor sit amet',
                'sort' => 1,
                'status' => 1,
                'created' => '2018-10-15 12:42:14',
                'modified' => '2018-10-15 12:42:14',
                'type' => 'Lorem ipsum d',
