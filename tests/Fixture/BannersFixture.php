...
class BannersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'file_mobile' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'order' => 1,
                'status' => 1,
                'created' => '2018-09-03 22:53:05',
                'modified' => '2018-09-03 22:53:05'
            ],
        ];
        parent::init();
    }
